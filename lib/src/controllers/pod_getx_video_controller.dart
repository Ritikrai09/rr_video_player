...
class PodGetXVideoController extends _PodGesturesController {
  ...
  RRVideoPlayerType get videoPlayerType => _videoPlayerType;
  ...
  Future<void> _initializePlayer() async {
    switch (_videoPlayerType) {
      case RRVideoPlayerType.network:
        ...
        break;
      case RRVideoPlayerType.networkQualityUrls:
        ...
        break;
      case RRVideoPlayerType.youtube:
      ...
      case RRVideoPlayerType.file:
        ...
        break;
      case RRVideoPlayerType.vimeoPrivateVideos:
