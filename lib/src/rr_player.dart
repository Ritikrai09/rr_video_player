...
class RRVideoPlayer extends StatefulWidget {
  ...
  final RRProgressBarConfig podProgressBarConfig;
  final RRPlayerLabels podPlayerLabels;
  ...
  RRVideoPlayer({
    ...
    this.podProgressBarConfig = const RRProgressBarConfig(),
    this.podPlayerLabels = const RRPlayerLabels(),
    this.overlayBuilder,
    this.videoTitle,
